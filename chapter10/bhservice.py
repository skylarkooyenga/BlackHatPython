# helper script that will periodically copy a script to a temp directory and execute it
# Skylar Kooyenga | 11/14/2023 | Python 3.10
...
class BHServerSvc(win32serviceutil.ServiceFramework):
    ...
    _svc_description = ("Executes VBScripts at regular intervals." + " What could possibly go wrong?")
