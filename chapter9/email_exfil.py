# transfer encrypted files via email
# Skylar Kooyenga | 11/7/2023 | Python 3.12
...
smtp_port = 587
smtp_acct = 'time@example.com'
smtp_password = 'seKret'
tgt_accts = ['time@elsewhere.com']
...
if __name__ == '__main__':
    plain_email('test message', 'Attack at dawn.')
